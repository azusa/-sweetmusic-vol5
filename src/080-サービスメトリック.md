...
[@lst:code_080_a]は、技術書典の著者が主宰するサークルの技術書典のサークルリストのページ@[[https://techbookfest.org/event/tbf04/circle](https://techbookfest.org/event/tbf04/circle)]での被チェック数をサービスメトリックとして
投稿するcurlコマンドの例です。
...
コンテンツ内にグラフを埋め込むことができます。([@fig:img_080_b])
